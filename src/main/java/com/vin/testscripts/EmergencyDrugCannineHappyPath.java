...
public class EmergencyDrugCannineHappyPath extends BaseTest {
	
	private String SecurityAnswerSecoreIDNumber, SecurityAnswerMothersMaidenName, parentWin;
	
	public EmergencyDrugCannineHappyPath() {
	...
	/**
	 * ====================================================================================================================
	 * Test Case Name: EmergencyDrugCannineHappyPath
	 * ====================================================================================================================
	 * @throws Exception 
	...
	@Test
	public void verifyEmergencyDrugCannineHappyPath() throws Exception
	{
    	...
    	loginPage=promoPage.navigateToEmergencyDrugCalculator();
         ...
         emergecyDrugFeline.selectDogForSpecies();
         
         reportLog("2.3: Enter Weight in lbs Text Field");
         emergecyDrugFeline.enterWeightInLbsForDogWeightTextBox();
         
         reportLog("2.4: Verify User is able to enter numeric text. KGs are calculated automatically");
         ...
         emergecyDrugFeline.verifyContentInTheRightPane(com.vin.utilities.Constants.VolumeContentForCanninehappyPath);
