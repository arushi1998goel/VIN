...
public class CustomReport implements IReporter {
  ...
  protected PrintWriter createWriter(String outdir) throws IOException {
    ...
    String outFilename = "CustomReport.html";
  ...
  protected void writeSuiteSummary() {
    ...
    for (SuiteResult suiteResult : suiteResults) {
      ...
      for (TestResult testResult : suiteResult.getTestResults()) {
        ...
        buffer.setLength(0);
        writeTableData(buffer.append("<a>")
        ...
        for (MethodResult methodResult : classResult.getMethodResults()) {
          ...
          for (ITestResult result : results) {
            ...
            for (Object parameter : result.getParameters()) {
              ...
              str.append(Utils.escapeHtml(Utils.toString(
                  parameter, Object.class))).append("\n");
            ...
            buffer.append("<td><a href=\"#m")
                ...
                .append("\">").append(methodName).append("</a></td>").append("<td>")
                .append(result.getMethod().getDescription()).append("</td>")
                .append("<td> ")
                .append(decimalFormat
                    .format(millisecondsToSeconds(duration)))
                .append("</td>").append("<td>").append(str).append("</td>").append("<td>")
                .append(firstLine).append("</td></tr>");
